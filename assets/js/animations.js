...
$('header ul li').on('click', function(){
    ...
    TweenMax.to(span, 0.4, { top: 3, opacity: 1, transformOrigin:"50% 50%", ease:Power1.easeInOut });
...
link2.on('click', function(){
    ...
    TweenMax.to(bar1, 0.5, { width: 152, transformOrigin:"0% 50%", ease:Power1.easeInOut });
    TweenMax.to(bar2, 0.5, { delay: 0.4, width: 92, transformOrigin:"0% 50%", ease:Power1.easeInOut });
    TweenMax.to(bar3, 0.5, { delay: 0.8, width: 156, transformOrigin:"0% 50%", ease:Power1.easeInOut });
